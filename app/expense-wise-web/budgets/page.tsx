...
function getBudgetDateRange(preset: DateRangePreset): { from: Date; to: Date } {
  const now = new Date();
  switch (preset) {
    case 'this-month':
...
function computeMonthlyBudgets(
...
const budgetPageHelpers = { getBudgetDateRange, getPrimaryCurrency, computeMonthlyBudgets };
...
export default function BudgetsPage() {
  ...
  const {
    ...
    availableMonths,
    monthlyStats,
  } = useBudgetPage(transactions, budgets, budgetPageHelpers);
